...
\begin{forest}
  proof,
  claim=α \land β \land Γ \land Δ \vdash α \land β \land Γ \land Δ
  [α \land β \land Γ \land Δ,idx=1
    [\lnot (α \land β \land Γ \land Δ),idx=2
      [α,idx=3,from=1
        [β,idx=4,from=1
          [Γ,idx=5,from=1
            [Δ,idx=6,from=1
              [\lnot α,idx=7,from=2,close]
              [\lnot β,idx=8,from=2,close]
              [\lnot Γ,idx=9,from=2,close]
              [\lnot Δ,idx=10,from=2,close]
            ]
          ]
        ]
      ]
